...
/*
 * $Id: MSMTRMX-driver.h 77 2011-11-30 19:03:16Z xander $
 */

/** \file MSMTRMX-driver.h
 * \brief RobotC Mindsensors RCX Motor MUX Driver
 *
 * MSMTRMX-driver.h provides an API for the Mindsensors RCX Motor MUX Driver.
...
bool MSMTRMX_Control(tSensors link, tMSMTRMXMotors channel, int power, ubyte address) {
  ...
  if (!writeI2C(link, MSMTRMX_I2CMessage, 0)) {
    return false;
  }
